        ...
        <footer className="bg-gray-900 text-white py-12">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div>
                <h3 className="text-xl font-bold mb-4">Fashism</h3>
                <p className="text-gray-400">Discover your unique style with our curated collections.</p>
              </div>
              <div>
            ...
            <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
              <p>&copy; {new Date().getFullYear()} Fashism. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </body>
